<!--
 * @Descripttion: 显示并下载二维码,此页面接收两个参数 1. 图片路径(imgUrl)默认'www.baidu.com' 2.二维码上的参数(code) 默认''
 * @version: 
 * @Author: zml
 * @Date: 2020-04-11 10:04:28
 * @LastEditors: zml
 * @LastEditTime: 2020-04-11 11:53:58
 -->
<template>
  <div class="showAndDown">
    <van-button type="primary" @click="getQRCode">显示并下载二维码</van-button>
		<!-- 显示二维码 -->
